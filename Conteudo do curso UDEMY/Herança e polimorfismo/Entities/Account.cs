...
//================================================================================================================
 /*
                ...
                Notação UML: itálico = nome da superclasse em italico 

                // QUESTIONAMENTO:
                    -   Se a classe Account não pode ser instanciada, porque simplesmente não criar
                    somente as classes SavingsAccount e BusinessAccount?
                Respotas:
                    -   Reuso: evitar duplicidade de codigos e evitar ter de fazer alterações em
                    varios arquivos com os mesmos dados da super.
                    -   Polimorfismo: a superclasse classe generica nos permite tratar de forma facil
                    e uniforme todos os tipos de conta, inclusive com polimorfismo se for o caso(como 
                    fizemos nos ultimos exercicios). Por exemplo: voce pode colocar todos os tipos de 
                    contas em uma mesma coleção.
                    
                    demo: suponha que voce queira:
                    *   Totalizar o saldo de todas as contas;
                    *   Sacar 10.00 de todas as contas
                        -   github.com/acenelio/inheritance6-csharp
            ...
            //========================================================================================
                //  MÉTODOS ABSTRATOS
                São métodos que não possuem implementações
